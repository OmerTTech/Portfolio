...
const NewProject = () => {
  return (
    <div className="pt-20 h-[360px] sm:h-[400px]  flex justify-center overflow-hidden">
      <div className="bg-main w-full md:w-[700px] sm:rounded-2xl flex flex-row items-center md:justify-between  text-white ">
        ...
        <div className="px-8 max-sm:ps-5 py-8 md:py-12 lg:py-16 flex flex-col text-center sm:text-start  items-center sm:items-start w-23/40 sm:w-10/20 ">
          ...
          <ScrollLink to="contact">
            <Button
              variant="contained"
              className="!capitalize !rounded-lg !p-3 lg:!p-3.5 !text-[16px] !font-[500] md:!pe-3.5 lg:!pe-3.5 !bg-white !text-main ease drop-shadow-sm drop-shadow-light-hover"
              endIcon={<TbSend2 />}
            >
              Contact Me
            </Button>
