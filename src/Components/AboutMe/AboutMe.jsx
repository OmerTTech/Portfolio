...
const AboutMe = () => {
  ...
  return (
    <div className="-ms-3 px-15 md:px-0 lg:px-15 h-full">
      ...
      {/* Responsive düzeni ana flex kapsayıcıya ekliyoruz */}
      <div className="flex flex-col md:flex-row  md:justify-around p-5 pt-15 relative">
        {/* Resim div'i mobil için tam genişlik, geniş ekranlar için %40 */}
          ...
          <div className="flex flex-col justify-center items-center pe-5">
            <div className="flex justify-center items-center mt-5 gap-4">
              <button
                ...
                className="text-2xl text-dark-hover hover:text-supdark-hover"
              >
                <FaArrowLeft />
              </button>
