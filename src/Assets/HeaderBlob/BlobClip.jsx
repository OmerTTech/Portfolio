...
const BlobClip = () => {
  ...
  return (
    <div className="ps-20 sm:ps-0">
      <div
        className="w-[320px] h-[320px] sm:w-[380px] sm:h-[320px] md:w-[320px] md:h-[320px] bg-main hover:bg-[#5b7fd1] transition ease overflow-hidden scale-90 sm:scale-90 md:scale-100"
        style={{
